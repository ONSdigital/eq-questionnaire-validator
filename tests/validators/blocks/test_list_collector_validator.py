...
def test_invalid_list_collector_repeating_blocks_multiple_list_collectors_different_section():
    filename = "schemas/invalid/test_invalid_list_collector_repeating_blocks_multiple_list_collectors_different_section.json"
