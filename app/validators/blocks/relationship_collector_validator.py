...
class RelationshipCollectorValidator(BlockValidator):
    """Validates blocks of type "RelationshipCollector" in a questionnaire schema.
    ...
    def validate(self):
        """Validates the RelationshipCollector block by invoking specific validation methods in order.
    ...
    def validate_answer_type(self):
        """Validates that the answer type of the first answer in the block is of type 'Relationship'."""
    ...
    def validate_multiple_answers(self):
        """Validates that there is only one answer in the block."""
    ...
    def validate_list_exists(self):
        """Validates that the list specified in the 'for_list' property of the block is used in the questionnaire
        schema.
        """
    ...
    def validate_unrelated_block(self):
        """Validates the unrelated block if it exists.It creates instance of UnrelatedBlockValidator to validate
        the unrelated block.
        """
